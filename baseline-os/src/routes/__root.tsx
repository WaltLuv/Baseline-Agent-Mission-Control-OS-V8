...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Baseline Automations — Operator Dashboard" },
      {
        name: "description",
        content:
          "Read-only observability dashboard for Claude Code workspaces, skills, memory, runs and outputs.",
      },
      { property: "og:title", content: "Baseline Automations — Operator Dashboard" },
      { name: "twitter:title", content: "Baseline Automations — Operator Dashboard" },
      {
      ...
      {
        property: "og:image",
        content: "https://raw.githubusercontent.com/WaltLuv/baseline-agent-os/main/docs/screenshot.png",
      },
      {
        name: "twitter:image",
        content: "https://raw.githubusercontent.com/WaltLuv/baseline-agent-os/main/docs/screenshot.png",
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,300..800&family=Manrope:wght@300..800&family=JetBrains+Mono:ital,wght@0,300..800;1,300..800&family=Caveat:wght@400..700&display=swap",
      },
    ],
  }),
...
function RootComponent() {
  ...
  const isStandalone =
    location.pathname.startsWith("/workforce-os") ||
    location.pathname === "/demo" ||
    location.pathname === "/setup" ||
    location.pathname === "/app/activate";
