...
Why: this folder powers my Documents gallery in Baseline OS. Files appear there within 5 seconds of you writing them. Without the title + description fields the cards fall back to filenames, which is ugly.
