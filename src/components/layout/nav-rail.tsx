...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'team', label: 'Team', icon: <UsersIcon />, priority: false, essential: true },
      { id: 'runtime-keys', label: 'Runtime keys', icon: '🔑', priority: false },
      { id: 'agent-gateway', label: 'Agent Gateway', icon: '🛰️', priority: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pi-agent', label: 'PI Agent', icon: <OfficeIcon />, priority: false },
      { id: 'propcontrol-empire', label: 'PropControl Empire', icon: <OfficeIcon />, priority: false },
  ...
  // setup/connect state (never a 404, never hidden). Source: src/lib/parity/surfaces.ts.
  {
    ...
    items: [
      ...
      { id: 'flight-deck', label: 'Flight Deck', icon: '🛰️', priority: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'video-studio', label: 'Video / Creative Studio', icon: '🎞️', priority: false },
...
const navItemTranslationKeys: Record<string, string> = {
  ...
  office: 'propcontrol-empire',
  'propcontrol-empire': 'propcontrol-empire',
  'pi-agent': 'pi-agent',
  cron: 'cron',
  webhooks: 'webhooks',
  alerts: 'alerts',
        ...
        <div className={`flex items-center shrink-0 ${sidebarExpanded ? 'px-3 py-3 gap-2.5' : 'flex-col py-3 gap-2'}`}>
          ...
          {sidebarExpanded && (
            <div className="flex items-baseline gap-2 truncate flex-1 min-w-0">
              <span className="text-sm font-semibold text-foreground truncate">Baseline Automations</span>
