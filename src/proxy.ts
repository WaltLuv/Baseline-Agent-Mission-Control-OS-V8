...
export function proxy(request: NextRequest) {
  ...
  if (pathname === '/' || pathname === '/login' || pathname === '/setup' || pathname === '/pricing' || pathname === '/marketplace' || pathname === '/roi-calculator' || pathname === '/api/stripe/webhook' || pathname.startsWith('/_next/') || pathname.startsWith('/_next/image') || pathname.startsWith('/api/auth/') || pathname === '/api/setup' || pathname === '/api/marketplace/catalog' || pathname.startsWith('/briefing/share') || pathname.startsWith('/demo/') || pathname === '/api/demo-share/verify' || pathname === '/api/demo-share/redeem' || pathname === '/api/docs' || pathname === '/docs' || pathname.startsWith('/downloads/') || pathname === '/downloads' || isPublicHealthProbe) {
