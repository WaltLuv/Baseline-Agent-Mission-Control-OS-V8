...
export function proxy(request: NextRequest) {
  ...
  if (pathname === '/' || pathname === '/login' || pathname === '/signup' || pathname === '/forgot-password' || pathname === '/reset-password' || pathname.startsWith('/invite/') || pathname === '/setup' || pathname === '/pricing' || pathname === '/marketplace' || pathname === '/roi-calculator' || pathname === '/flight-deck' || pathname === '/download' || pathname === '/api/stripe/webhook' || pathname.startsWith('/_next/') || pathname.startsWith('/_next/image') || pathname.startsWith('/api/auth/') || pathname.startsWith('/api/invites/') || pathname === '/api/setup' || pathname === '/api/marketplace/catalog' || pathname.startsWith('/briefing/share') || pathname.startsWith('/demo/') || pathname === '/api/demo-share/verify' || pathname === '/api/demo-share/redeem' || pathname === '/api/docs' || pathname === '/docs' || pathname.startsWith('/downloads/') || pathname === '/downloads' || pathname.startsWith('/api/flight-deck/') || isPublicHealthProbe) {
