...
export const FEATURE_SURFACES: FeatureSurface[] = [
  ...
  { slug: 'slim-voice', label: 'Slim Charles', category: 'Agents & Runtimes', baselineRoute: '/agents/hermes', mcRoute: '/app/slim-voice', status: 'live', description: 'Slim Charles — chat + realtime voice (Oracle Control System) driving the real Hermes agent.' },
