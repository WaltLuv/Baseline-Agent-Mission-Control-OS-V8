...
export const FEATURE_SURFACES: FeatureSurface[] = [
  ...
  { slug: 'hyperframes', label: 'HyperFrames', category: 'Creative', baselineRoute: '/hyperframes', mcRoute: '/app/hyperframes', status: 'setup_needed', description: 'HTML→MP4 rendering provider.', enableHint: 'Add a HeyGen/HyperFrames credential + connect a render runtime.', enableHref: '/app/credentials' },
