...
export const FEATURE_SURFACES: FeatureSurface[] = [
  ...
  { slug: 'hermes', label: 'Hermes (MCP Enterprise)', category: 'Agents & Runtimes', baselineRoute: '/agents/hermes', mcRoute: '/app/hermes', status: 'live', description: 'Enterprise operator — tool/skill/provider/runtime registries, MCP status, execution + approval logs, graph-first, replay + proof.' },
  ...
  { slug: 'gemini', label: 'Gemini Flow', category: 'Agents & Runtimes', baselineRoute: '/agents/gemini', mcRoute: '/app/gemini', status: 'live', description: 'Google Flow-style workflow workspace — graph-first task graph, artifacts, agents/providers (not a chatbot).' },
  ...
  { slug: 'graphify', label: 'Graphify (Structural Brain)', category: 'Knowledge', baselineRoute: '/graphify', mcRoute: '/app/graphify', status: 'live', description: 'Codebase knowledge graph (brain layer #5) — agents query it before scanning the repo.' },
  { slug: 'replay', label: 'Workforce Replay', category: 'Workforce', baselineRoute: '/replay', mcRoute: '/app/replay', status: 'live', description: 'Replay any mission like a screen recording — trigger→agents→tools→files→approvals→outputs (workspace-scoped).' },
  { slug: 'maintenance', label: 'Maintenance Execution', category: 'Workforce', baselineRoute: '/maestro', mcRoute: '/app/maintenance', status: 'live', description: 'PM maintenance workflow — triage→work order→vendor→owner approval→dispatch (live or dry-run), proof + replay.' },
  { slug: 'approvals', label: 'Owner Approval Inbox', category: 'Workforce', baselineRoute: '/maestro', mcRoute: '/app/approvals', status: 'live', description: 'Owner spend approvals — approve/deny/request-info, audit trail, proof + replay links.' },
  { slug: 'comms', label: 'Communications', category: 'Workforce', baselineRoute: '/maestro', mcRoute: '/app/comms', status: 'live', description: 'SMS/email connect (Twilio/Resend-ready) — live or honest dry-run; communication log + templates.' },
  { slug: 'kanban-gallery', label: 'Self-Driving Kanban 2.0', category: 'Workforce', baselineRoute: '/kanban', mcRoute: '/app/kanban-gallery', status: 'live', description: 'Idea→5-floor plan→approval→build→self-check→shipped gallery; PM templates; proof+replay. Graph-first.' },
  { slug: 'flight-deck', label: 'Flight Deck (Control Tower)', category: 'Workforce', baselineRoute: '/flight-deck', mcRoute: '/app/flight-deck', status: 'live', description: 'Executive control tower — runtimes/comms/billing/approvals/replay/proof/health, all live data or honest setup-needed.' },
